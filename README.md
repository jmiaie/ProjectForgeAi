...
Tests: `PYTHONPATH=backend/app python3 -m unittest discover -s backend/app/tests` (161 tests)
...
- **SaaS platform** — multi-tenant isolation, observability, GPG bundles, billing quotas, Stripe checkout/subscriptions/webhooks, Neo4j tenant DB auto-provision + read replicas, Grafana dashboards/alerts
                                                                            ...
                                                                            └── cursor/sprint20-otel-billing-ebb0
                                                                                 └── cursor/sprint21-grafana-stripe-neo4j-ebb0
                                                                                      └── cursor/sprint22-webhooks-neo4j-cloud-ebb0
                                                                                           └── cursor/sprint23-subscriptions-replica-alerts-ebb0   ← active
```
