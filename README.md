...
Tests: `PYTHONPATH=backend/app python3 -m unittest discover -s backend/app/tests` (153 tests)
...
- **SaaS platform** — multi-tenant isolation, observability, GPG bundles, billing quotas, Stripe checkout/webhooks, Neo4j tenant DB auto-provision, Grafana dashboards
                                                                       ...
                                                                       └── cursor/sprint19-saas-observability-ebb0
                                                                            └── cursor/sprint20-otel-billing-ebb0
                                                                                 └── cursor/sprint21-grafana-stripe-neo4j-ebb0
                                                                                      └── cursor/sprint22-webhooks-neo4j-cloud-ebb0   ← active
```
