...
- **SaaS platform** — multi-tenant isolation, observability/SLOs/capacity/autoscale hooks, billing quotas/overage scheduler, Stripe checkout/subscriptions/portal, tenant export/import, Neo4j cluster failover/auto-heal, multi-region routing/migration, Grafana dashboards/alerts
                                                        ...
                                                        └── cursor/sprint16-identity-deploy-ebb0
                                                             └── cursor/sprint17-portfolio-intelligence-ebb0
                                                                  └── cursor/sprint18-airgap-hardening-ebb0
                                                                       └── cursor/sprint19-saas-observability-ebb0
                                                                            └── cursor/sprint20-otel-billing-ebb0
                                                                                 └── cursor/sprint21-grafana-stripe-neo4j-ebb0
                                                                                           ...
                                                                                           └── cursor/sprint23-subscriptions-replica-alerts-ebb0
                                                                                                └── cursor/sprint24-portal-cluster-slo-ebb0
                                                                                                     └── cursor/sprint25-metering-region-heal-ebb0
                                                                                                          └── cursor/sprint26-invoice-migrate-capacity-ebb0
                                                                                                               └── cursor/sprint27-scheduler-portability-autoscale-ebb0   ← active
```
