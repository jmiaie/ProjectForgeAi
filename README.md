...
Tests: `PYTHONPATH=backend/app python3 -m unittest discover -s backend/app/tests` (173 tests)
...
- **SaaS platform** — multi-tenant isolation, observability/SLOs, GPG bundles, billing quotas, Stripe checkout/subscriptions/portal, Neo4j tenant DB auto-provision + read replicas + cluster failover, Grafana dashboards/alerts
                                                                                 ...
                                                                                 └── cursor/sprint21-grafana-stripe-neo4j-ebb0
                                                                                      └── cursor/sprint22-webhooks-neo4j-cloud-ebb0
                                                                                           └── cursor/sprint23-subscriptions-replica-alerts-ebb0
                                                                                                └── cursor/sprint24-portal-cluster-slo-ebb0   ← active
```
